...
android {
    ...
    RESOURCES = zirkcoin.qrc

build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.zirkcoin
    BOOST_LIB_SUFFIX=-mt
...
build_win32 {
    ...
    BDB_INCLUDE_PATH=c:/deps/db-4.8.30.NC/build_unix
    BDB_LIB_PATH=c:/deps/db-4.8.30.NC/build_unix
    OPENSSL_INCLUDE_PATH=c:/deps/openssl_1.0.1i/include
    OPENSSL_LIB_PATH=c:/deps/openssl_1.0.1i/lib/
