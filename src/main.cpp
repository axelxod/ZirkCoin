...
const string strMessageMagic = "ZirkCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZirkCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    };
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
        ...
        || (nNodeMode != NT_FULL && mapBlockThinIndex.empty()))
    {
        ...
        const char* pszTimestamp = "Bitcoin #347613 8ee517224127c1ddeaea6c35631405065e29fa9b5adb069";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 420748 : 420748;
        ...
        assert(block.hashMerkleRoot == uint256("0xa9a647124395349e34f23d8b4ab9a202eb0975ccb4f514c910800b33ab77e91e"));
...
unsigned char pchMessageStart[4] = { 0xa3, 0xd1, 0xac, 0xe2 };
